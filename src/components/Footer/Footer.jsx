      ...
      <MyContainer className="footer sm:footer-horizontal p-10 md:px-0 lg:p-10">
        <div className="">
          <div className="flex flex-col md:flex-row md:items-center">
            ...
            <div className="">
              {" "}
              <p className="">Got Question? Call us 24/7</p>
              <a href="tel:+8801713267313" className="">
                +8801713267313
              </a>
              <p className="">
                {" "}
                3rd Floor, Bashundara R/A Road, <br /> Opposite of Jamuna Future
                Park Pocket Gate.
              </p>
            </div>
          </div>
        ...
        <nav>
          ...
          <a className="link link-hover">Pet Products</a>
          <a className="link link-hover">Veterinary Services</a>
          <a className="link link-hover">Cat Fostering</a>
        </nav>
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover">Term and Conditions</a>
        </nav>
      </MyContainer>
    </div>
  );
